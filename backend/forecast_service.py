    ...
    for day in range(1, 8):
        ...
        rows.append({
            ...
            "prediction_debug": {
                ...
                "calibrated_output": prediction.get("calibrated_output"),
                "final_aqi": prediction.get("final_aqi"),
                "expected_aqi_range": prediction.get("expected_aqi_range"),
                "warnings": prediction.get("warnings", []),
                "processed_features": prediction.get("processed_features", {}),
            },
