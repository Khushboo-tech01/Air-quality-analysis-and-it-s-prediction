...
export const POLLUTANT_META = {
  pm25:     { label: "PM2.5",       unit: "ug/m3", placeholder: "35",   step: 0.1 },
  pm10:     { label: "PM10",        unit: "ug/m3", placeholder: "80",   step: 0.1 },
  no2:      { label: "NO2",         unit: "ug/m3", placeholder: "25",   step: 0.1 },
  so2:      { label: "SO2",         unit: "ug/m3", placeholder: "8",    step: 0.1 },
  co:       { label: "CO",          unit: "mg/m3", placeholder: "0.8",  step: 0.01 },
  o3:       { label: "O3",          unit: "ug/m3", placeholder: "30",   step: 0.1 },
  temp:     { label: "Temperature", unit: "deg C", placeholder: "26",   step: 0.1 },
